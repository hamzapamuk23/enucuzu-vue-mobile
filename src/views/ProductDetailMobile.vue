<template>
    <v-row class="mt-5 mx-2 elevation-3" width="100%" align="center">
        <v-col width="50%" >
            <v-card max-width="35%" class="elevation-3" style=" display:inline-block; overflow:hidden; white-space: nowrap; text-overflow: ellipsis;" >
            ...
            <v-div class="ml-5"  style="display:inline-block; position: relative; " >
